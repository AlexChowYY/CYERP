...
public class InviteRewardActivity extends BaseActivity {
    private static final String TAG = "InviteRewardActivity";
    @BindView(R.id.iv_layout_top_back)
    ImageView mBackIV;
    @BindView(R.id.tv_layout_top_back_title)
    TextView mTitleTV;
    @BindView(R.id.rv_activity_invite_reward)
    RecyclerView mRV;
    ...
    public void initData() {
        mTitleTV.setText(R.string.invite_reward);
        getIncome();
